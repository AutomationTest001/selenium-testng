...
public class LoginTestJSmith {
	...
	public static void main(String[] args) throws Exception {		
		...
		w.findElement(By.id("uid")).sendKeys("jsmith"); // Step 2 : Enter username

		w.findElement(By.name("passw")).sendKeys("Demo1234"); // Step 3 : Enter password
